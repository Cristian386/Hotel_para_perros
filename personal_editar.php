...
if (false == $cita) {
    header('Location: personal.php?info=No se encontró el personal');
    exit;
}
?>
<!DOCTYPE html>
                ...
                <form action="personal_guardar.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="especialidad" id="especialidad1" value="veterinario" <?php echo 'veterinario' == $cita['especialidad'] ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="especialidad1">Veterinario</label>
                            &nbsp;
                            <input class="form-check-input" type="radio" name="especialidad" id="especialidad2" value="cuidador" <?php echo 'cuidador' == $cita['especialidad'] ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="especialidad2">Cuidador</label>
                            &nbsp;
                            <input class="form-check-input" type="radio" name="especialidad" id="especialidad3" value="limpiador" <?php echo 'limpiador' == $cita['especialidad'] ? 'checked' : ''; ?>>
